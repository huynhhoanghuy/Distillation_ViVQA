...
def loss_fn_kd(outputs, labels, teacher_outputs, params):
    ...
    """
    # print("#################################")
    # print("outputs, labels, teacher_outputs:",outputs, labels, teacher_outputs)
...
def loss_fn_kd_intermediate(outputs, labels, teacher_outputs, student_inter, teacher_inter, params):
    """
    Compute the knowledge-distillation (KD) loss given outputs, labels.
    "Hyperparameters": temperature and alpha
    ...
    """
    Compute distance of intermediate features by MAE
    """

    student_cnn, student_vit = student_inter
    teacher_cnn, teacher_vit = teacher_inter
    alpha = params.alpha
    T = params.temperature
    # mae = nn.L1Loss()
    feat_kd_loss = nn.KLDivLoss()
    CE = torch.nn.CrossEntropyLoss(reduction='sum', label_smoothing=params.label_smooth)
