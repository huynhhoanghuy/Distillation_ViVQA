python3 train_4_distill.py --model 'GuidedAtt' \
                    ...
                    --output "/data/huy.hhoang/ViVQA_model/output/trained_models/GuidedAtt/2_5_KL_2_5_Vit_1_5_CNN" \
...
python3 train_4_distill.py --model 'GuidedAtt' \
                    ...
                    --data_dir '/data/huy.hhoang/ViVQA25' \
                    --output "/data/huy.hhoang/ViVQA_model/output/trained_models/GuidedAtt/2_5_KL_2_5_Vit_1_5_CNN" \
                    --init_lr 1e-5 --warmup_steps 5 --weight_decay 1e-5 \
                    --label_smooth 0.0 --dropout 0.3 \
                    --batch_size 32 --nepochs 40
